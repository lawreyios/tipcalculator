...
## Calculate those tips

You just ended your sumptuous dinner with your group of acquittances and each one of you starts to whip out your smartest phone, find the calculator app and starts to calculate the bill. Being armed with some programming background, why don't you build your own?

I'm glad your answer is Yes. Today, you will be using Kotlin, the first class programming language for Android to build a simple Tip Calculator.

In a nutshell, Kotlin is a statically-typed programming language that runs on the JVM. It eliminates excessive boilerplate code, introduces improved syntax, and due to its popularity, [Airbnb transitioned out from React Native](https://softwareengineeringdaily.com/2018/09/24/show-summary-react-native-at-airbnb/) in favor of Kotlin.

In this short tutorial, you'll learn:

* Basic features of Kotlin
* Build a working app with Kotlin

> **Note** This tutorial assumes you have some experience developing in Android with Java. If you are new to the Android world, you may want to try out some tutorials [here](https://developer.android.com/guide) before proceeding further.

#Getting Started

Download the [starter project](https://github.com/lawreyios/tipcalculator/tree/starter_project). Extract it in the folder of your choice and open the project in Android Studio 3.0 or later.

You will be building this Tip Calculator app which will allow users to:

1. Fill in bill amount
2. Fill in tip percentage
3. Fill in number of people
4. Generate Total Bill
5. Generate Total Tip
6. Generate Bill per person
7. Generate Tip per person

After you opened the project, you should see two main source files that we will be working on:

* MainActivity.kt
* activity_main.xml

There are nineteen TODOs placed around the project to guide you. 

Build and run the project to see what we have.

![](screenshots/tipcalculator1.png)

#Build the Interface

You can key in total amount but you cannot perform any other operations. We are going to fix that. Open up the TODOs list if you have not by going to `View -> Tool Windows -> TODO`. Then, open up `activity_main.xml` and replicate the first set of `TextView` and `EditText`, rename the `id`s to be 
...
```
    ...
    <EditText
      ...
      android:text="@string/tipTextDefaultValue"/>
```            

Do the same for `numberOfPeople`
...
```
    <TextView
      ...
      android:layout_height="wrap_content"
      style="@style/h4Bold"
      android:text="@string/numberOfPeopleTextLabel"/>
    ...
    <EditText
      ...
      android:layout_height="wrap_content"
      android:inputType="number"
      android:text="@string/numberOfPeopleTextDefaultValue"/>
```

Build and run the app. You should now see three fields which you can input numeric values.

![](screenshots/tipcalculator2.png)

Looking good! You now have the fields you need to perform some calculations. Next, add a button to perform the opertion. Add a fancy `Imagebutton` inside `RelativeLayout` 
...
To display the results, you will need a few more `TextView`s. Add these codes inside the next `LinearLayout` to complete the main inferface.
